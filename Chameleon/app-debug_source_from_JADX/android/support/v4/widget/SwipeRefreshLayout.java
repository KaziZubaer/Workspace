...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    class C00823 extends BaseAnimationListener {
        C00823() {
            super(null);
        }
    ...
    class C00834 extends BaseAnimationListener {
        C00834() {
            super(null);
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mReturnToStartPositionListener = new C00823();
        this.mShrinkAnimationListener = new C00834();
